...
INSERT INTO `albums` VALUES (1,'Goodbye & Goodbye & Good Riddance',1),(2,'Don\'t Forget About Me Demos',22);
...
CREATE TABLE `artists` (
  ...
  `album1_id` int DEFAULT NULL,
  PRIMARY KEY (`artist_id`),
  KEY `album1_id_idx` (`album1_id`),
  CONSTRAINT `album1_id` FOREIGN KEY (`album1_id`) REFERENCES `albums` (`album_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `artists` VALUES (1,'Juice WRLD',31,'Lucid Dreams','As of 2024 Juice WRLD is number 137 in the world.','yes',1),(2,'Ice Spice',23,'Think you the shit','As of 2024 Ice Spice is number 248 in the world.','no',NULL),(3,'21 Savage',64,'Redrum','As of 2024 21 is number 23 in the world.','no',NULL),(4,'Travis Scott',67,'Fe!n','As of 2024 Travis Scott  is number 19 in the world.','no',NULL),(5,'Kanye West',78,'Carnival','As of 2024 Kanye West is number 6 in the world.','yes',NULL),(6,'Central Cee',25,'Sprinter','As of 2024 Central Cee is number 214 in the world.','yes',NULL),(7,'Taylor Swift',104,'Cruel Summer','As of 2024 Taylor Swift is number 2 in the world.','yes',NULL),(8,'Drake',84,'Rich Baby Daddy','As of 2024 Drake is number 5 in the world.','yes',NULL),(9,'Olivia Rodrigo',58,'Vampire','As of 2024 Olivia Rodrigo is number 31 in the world.','no',NULL),(10,'The Weeknd',114,'One of the girls','As of 2024 The Weeknd is number 1 in the world.','yes',NULL),(11,'The Kid Laroi',31,'Stay','As of 2024 The Kid Laroi is number 138 in the world.','yes',NULL),(12,'Billie Eilish',67,'What Was I Made For','As of 2024 Billie Eilish is number 21 in the world.','no',NULL),(13,'Laufey',14,'From The Start','As of 2024 Laufey is number 330 in the world.','no',NULL),(14,'Lana Del Ray',58,'Summertime Sadness','As of 2024 Lana Del Rey is number 32 in the world.','no',NULL),(15,'Djo',32,'End of beginning','As of 2024 Djo is number 130 in the world.','yes',NULL),(16,'Dj Khalid',25,'Wild Thoughts','As of 2024 Dj Khaled is number 224 in the world.','yes',NULL),(17,'Justin Bieber',78,'Ghost','As of 2024 Justin Bieber is number 7 in the world.','no',NULL),(18,'Frank Sinatra',17,'Somethin\' Stupid','As of 2024 Frank Sinatra is number 464 in the world.','yes',NULL),(19,'Micheal Bublé',17,'Spicy Margarita','As of 2024 Michael Bubléis number 454 in the world.','no',NULL),(20,'Sean paul',33,'No Lie','As of 2024 Sean Paul is number 123 in the world.','no',NULL),(21,'Queen',52,'Don\'t Stop Me Now','As of 2024 Queen is number 45 in the world.','no',NULL),(22,'Dominic Fike',20,'Baby Doll','As of 2024 Dominic Fike is number 341 in the world.','yes',NULL);
...
-- Dump completed on 2024-03-21 13:50:57
